 ...
 */
final class Version20230711090455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE times (id INT AUTO_INCREMENT NOT NULL, workshops_id INT DEFAULT NULL, day VARCHAR(20) NOT NULL, open_am DATETIME NOT NULL, close_am DATETIME NOT NULL, open_pm DATETIME NOT NULL, close_pm DATETIME NOT NULL, INDEX IDX_1DD7EE8CBEDD5CD7 (workshops_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
